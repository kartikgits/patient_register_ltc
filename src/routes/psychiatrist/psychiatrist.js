...
module.exports = (app) => {
    ...
    app.post('/auth/patient-signup', [authJwt.verifyToken, verifySignUp.validatePatientSignUp('signup'), verifySignUp.checkDuplicatePatientEmailAndPsychiatristId], patientAuth.signup);
}